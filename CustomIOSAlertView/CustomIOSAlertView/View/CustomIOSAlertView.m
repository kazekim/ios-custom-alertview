...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        [closeButton setTitleColor:[UIColor colorWithRed:0.18f green:0.66f blue:0.33f alpha:1.0f] forState:UIControlStateNormal];
        [closeButton setTitleColor:[UIColor colorWithRed:0.0f green:1.0f blue:0.0f alpha:1.0f] forState:UIControlStateHighlighted];
